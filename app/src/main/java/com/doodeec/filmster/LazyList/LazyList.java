    ...
    protected synchronized void onDataLoadingFailed(int reason, final Integer page) {
        ...
        switch (reason) {
            case REASON_LIST_END:
                Toast.makeText(AppState.getCurrentActivity(), R.string.list_end, Toast.LENGTH_SHORT).show();
                mBlockLazyLoad = true;
                break;
            case REASON_SERVER_ERROR:
                Toast.makeText(AppState.getCurrentActivity(), R.string.server_error_msg, Toast.LENGTH_SHORT).show();
                break;
            case REASON_CONNECTION_LOST:
                break;
            default:
                Toast.makeText(AppState.getCurrentActivity(), R.string.unknown_error, Toast.LENGTH_SHORT).show();
                //TODO throw error?
                break;
        }
